 ...
 */
final class Version20221213170730 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place ADD CONSTRAINT FK_741D53CDA89DB457 FOREIGN KEY (business_id) REFERENCES business (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
