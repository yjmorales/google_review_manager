 ...
 */
function BusinessFormValidator(config = {}) {
    /**
     * Holds the UI References.
     * @type {Object}
     */
    const ui = {
        $form: config && config.formSelector ? $(config.formSelector) : $('form[name="business_form"]'),
    };
     ...
     */
    function validate() {
        ui.$form.validate(getValidatorSettings());
    }

    /**
     * Holds the validation settings.
     * @return {Object}
     */
